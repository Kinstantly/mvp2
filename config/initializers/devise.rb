...
Devise.setup do |config|
  ...
  config.secret_key = ENV['DEVISE_SECRET_KEY'].presence || 'c3342a1f49e8602eba0bbdb00765a183246c834544361f8922037985b5e696c9088e7867f286df03c763651b13b85f476812df37a3dde681b208162ed512542a'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class with default "from" parameter.
  config.mailer_sender = MAILER_DEFAULT_FROM
  ...
  # config.pepper = "6363312cab91747cd5affc0b084a78790fc3293a7491320442a8b1b4f1720682e1d6d451460c5a92e0ada480380f9e24e10886dccfb120e714c30778401ba3e1"
  ...
  # 
  # Require a valid domain format and something before the @ character.
  config.email_regexp = /\A[\w._%+-]+@(?:[\w-]+\.)+[\w]{2,}\z/
  ...
  # During testing, cucumber will only do a GET.
