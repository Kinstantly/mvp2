class ApplicationController < ActionController::Base
	...
	def configure_permitted_devise_parameters
		devise_parameter_sanitizer.for(:sign_up) { |u| u.permit(*User::DEFAULT_ACCESSIBLE_ATTRIBUTES) }
		devise_parameter_sanitizer.for(:account_update) { |u| u.permit(*User::DEFAULT_ACCESSIBLE_ATTRIBUTES) }
	end
end
