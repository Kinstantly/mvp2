Feature: Subscribe to newsletters and/or marketing emails
	...
	Scenario: Provider should be fully subscribed before confirmation
		When I sign up as a provider on the regular site and subscribe to the "provider_newsletters and parent_newsletters" mailing lists
			And I see an unconfirmed account message
		Then I should only be subscribed to the "provider_newsletters and parent_newsletters" mailing lists and synced to the list server
	...
	Scenario: Provider should be fully subscribed after registering while claiming their profile
		When I have been invited to claim a profile
			...
			And I sign up as a provider on the regular site and subscribe to the "provider_newsletters and parent_newsletters" mailing lists
